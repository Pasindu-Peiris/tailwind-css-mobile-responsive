...
const Homesection6 = () => {
  return (
    <div className=' w-[100%] h-[40vh] md:h-[auto] sm:h-[auto] sm:p-2 xsm:p-2 xsm:h-[auto] sm:mb-10 sm:mt-12 xsm:gap-5 xsm:gid xsm:flex-col md:mb-5 xsm:mt-12 xl:flex md:grid xl:flex-row  md:flex-col sm:grid sm:flex-col md:gap-4 sm:gap-4 justify-center items-center '>

        <div className="box-1 p-5 border-2 border-gray-200 w-[400px] sm:w-[100%] xsm:w-[100%] h-[auto] xl:mx-5 xsm:my-5">
